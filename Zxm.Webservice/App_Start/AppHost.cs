...
[assembly: WebActivator.PreApplicationStartMethod(typeof(Zxm.Webservice.App_Start.AppHost), "Start")]
...
namespace Zxm.Webservice.App_Start
{
	...
	{		
		public AppHost() //Tell ServiceStack the name and where to find your web services
			: base("StarterTemplate ASP.NET Host", typeof(UserService).Assembly) { }
